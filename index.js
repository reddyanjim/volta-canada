  ...
  return (
    <main className="min-h-screen bg-white text-gray-900">
      ...
      <section className="px-6 py-12 bg-gray-50">
        <h3 className="text-2xl font-semibold mb-4">Why Choose VoltaCanada?</h3>
        <ul className="max-w-2xl mx-auto space-y-2 text-left">
          <li>✔️ 15% commission model – more take-home pay</li>
          <li>✔️ Canadian-owned and operated</li>
          <li>✔️ Transparent payouts and local support</li>
          <li>✔️ Delivery and ride-share in one app</li>
        </ul>
      </section>
